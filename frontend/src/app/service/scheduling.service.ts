...
export class SchedulingService {
  ...
  public addScheduing(data: any) {
    return this.httpClient.post(environment.apiEndpoint + "/scheduling/add", data)
  }
  public getAllScheduing() {
    return this.httpClient.get(environment.apiEndpoint + "/scheduling/get")
  }
  public deleteScheduling(id: number) {
    return this.httpClient.delete(environment.apiEndpoint + `/scheduling/delete/${id}`)
  }
  public updateScheduling(id: number, data: any) {
    return this.httpClient.put(environment.apiEndpoint + `/scheduling/update/${id}`, data)
  }
}
